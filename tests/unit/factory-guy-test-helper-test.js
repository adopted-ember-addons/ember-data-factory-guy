...
/**
 ...
 is not important
 */
module('FactoryGuyTestHelper#mockFind', inlineSetup(App, serializerType));
...
module('FactoryGuyTestHelper#mockFindAll', inlineSetup(App, serializerType));
...
module('FactoryGuyTestHelper#mockQuery', inlineSetup(App, serializerType));
...
module('FactoryGuyTestHelper#mockQueryRecord', inlineSetup(App, serializerType));
