 ...
 * (to get your own copy of a new application), just clearing the store at the end
 * is fine. Every model test can do this and as long as you keep clearing the store
 * your fine.
 */
